...
require (
	...
	k8s.io/apiserver v0.30.2 // @grafana/grafana-app-platform-squad
	k8s.io/client-go v0.30.2 // @grafana/grafana-app-platform-squad
	k8s.io/component-base v0.30.2 // @grafana/grafana-app-platform-squad
